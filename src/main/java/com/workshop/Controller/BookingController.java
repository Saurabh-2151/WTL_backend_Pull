...
@Controller
@CrossOrigin(origins = "http://localhost:3001,http://localhost:3000,http://localhost:8085")
public class BookingController {
	...
	private final String apiKey = "AIzaSyAKjmBSUJ3XR8uD10vG2ptzqLJAZnOlzqI"; // Replace with your Google API key
